...
<div className=' text-white bg-[#41474e] rounded-full h-[6vh] w-[9vw] text-sm font-medium flex justify-center pt-3 mt-3 ml-[10vw] shadow-white shadow-[-1px_-1px_5px_0px_#ffffff] max-xl:text-xs'> + ADD IMAGE</div>
